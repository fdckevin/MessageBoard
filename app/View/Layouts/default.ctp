...
<head>
	...
	<?php
		...
		echo $this->Html->css('https://ajax.googleapis.com/ajax/libs/jqueryui/1.12.1/themes/ui-lightness/jquery-ui.css');
  ...
  <div class="navbar-nav ml-auto">
    ...
    <li class="nav-item dropdown">
      ...
      <div class="dropdown-menu">
      	...
      	<?php echo $this->Html->link('Change Password', '/home/changepassword', array('class' => 'dropdown-item'));?>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			$('#registerForm').submit(function(e){
	            ...
	            if(!(name.length >=5 && name.length <= 20)) {
	            	 ...
	            	 message += "Name should be at least 5-20 characters";
		...
		$('#changePasswordForm').submit(function(e){
	      ...
	      return false;
			...
			$.ajax({
				url: '<?php echo $this->Html->url('/home/changepassword');?>',
				method: 'POST',
				data: new FormData(this),
				contentType: false,
				processData: false,
		...
		function getProfile() {
			...
			$.ajax({
				...
				success: function(data) {
					...
					if(data['Users']['image']!=null && data['Users']['image']!="") {
